...
и если длина кода города меньше, чем соответствующая секция шаблона, форматирование может ухудшить внешний вид номера. Для решения этой проблемы рекомендуется форматировать телефоны частями. Программа позволяет это, поскольку
