...
ВНИМАНИЕ! Автоматический выбор страны невозможен, поскольку для разных стран одному и тому же национальному префиксу могут соответствовать
разные международные. Например, для России 8 переводится в +7, для Белоруссии тот же 8 переводится в +375.
