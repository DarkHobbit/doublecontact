...
понимают формат vCard версий 3.0 или 4.0. Однако для некоторых устройств требуется vCard 2.1. Задать версию vCard можно в окне настроек
...
для некоторых стран. Для Беларуси эта операция заменяет префикс 8 на код страны +375, для России - 8 на +7,
...
могут соответствовать разные международные. Например, для России 8 переводится в +7, для Беларуси тот же 8 переводится в +375.
...
заполнялась в России, а другая в Беларуси. Особо тяжёлый случай - когда телефоны с "национальной" записью
для Беларуси и России присутствуют в одном контакте. Эту ситуацию можно исправить только вручную. К счастью,
