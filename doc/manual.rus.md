...
* загрузка и сохранение адресных книг следующих форматов:
  - VCF (поддерживаются vCard 2.1, 3.0 и 4.0, а также возможность загрузки каталога, содержащего множество файлов VCF, как единой адресной книги);
...
но и историю вызовов и SMS (данные, не поддерживаемые в VCF и UDX). Если сохранить MPB в VCF, а потом снова в MPB, история вызовов и SMS будут
утеряны!
