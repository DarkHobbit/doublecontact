...
содержащего множество файлов VCF, как единой адресной книги), CSV (поддерживаются различные профили),
UDX (Philips Xenium), MPB (резервная копия MyPhoneExplorer) и сохранение адресных книг в указанных форматах;
* импорт файлов NBU (резервная копия Nokia);
...
электронной таблице, и который сохранит всю информацию о контактах, используйте профиль "Универсальный".
...
Сортировка контактов по столбцам включается и выключается клавишей F4. Порядок сортировки задаётся щелчками мыши
...
нажав кнопку "<>". На этой же вкладке можно указать должность и название организации.
...
копируем его в правую (вообще говоря, это необязательно, если мы будем сохранять только левую панель, d\
...
Полученный файл Вы можете распечатать или поместить на своём сайте.
...
с программой в некоторых файловых менеджерах.
