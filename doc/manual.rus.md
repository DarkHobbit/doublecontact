...
Форматом vCard предусмотрен тег CATEGORIES для указания, к какой группе или группам относится контакт. Однако Большинство телефонов под управлением ОС Android не используют этот тег или сохраняют в нём служебную информацию. Поэтому при сохранении адресной книги информация о группах теряется.
...
DoubleContact поддерживает запись этих тегов, а также стандартного тега CATEGORIES. Если Вы собираетесь импортировать контакты на телефон одного из этих производителей, выберите соответствующий тег в окне настроек
